...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition">
      ...
      <sch:assert test="count(f:extension[@url = 'http://ema.europa.eu/fhir/StructureDefinition/ext-epi-qrdtemplate-version']) &lt;= 1">extension with URL = 'http://ema.europa.eu/fhir/StructureDefinition/ext-epi-qrdtemplate-version': maximum cardinality of 'extension' is 1</sch:assert>
